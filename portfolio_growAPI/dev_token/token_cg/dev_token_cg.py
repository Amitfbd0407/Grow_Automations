...
class CgTokenBot(refund_sms):
    def __init__(self, business_identifier):
        ...
        super().__init__(f"dev_cg_token_{business_identifier}")
    ...
    def start(self):
        ...
        try:
            ...
            amount = StaticFunctions.get_amount(self.automation_name, Amount.token_cg1, Amount.token_cg2)
            ...
            extra = {
                ...
                "cField1": Fields.token_cg_1,
                "cField2": Fields.token_cg_2,
                "maxPaymentNum": "6",
                "paymentNum": "1",
                "saveCardToken": "1",
            }
