...
class SdkWalletJ4j5Bot(refund_sms):
    def __init__(self, business_identifier):
        ...
        super().__init__(f"dev_sdk_wallet_j4j5_{business_identifier}")
    ...
    def start(self):
        ...
        try:
            ...
            amount = StaticFunctions.get_amount(self.automation_name, Amount.j4j5_sdk1, Amount.j4j5_sdk2)

            self.current_step = "API Auth (Get AuthCode J5)"
            extra = {
                "pageCode": p_code,
                "userId": u_id,
                "description": f"{Descriptions.sdk} Wallet J4/J5 Flow",
                "chargeType": ChargeType.j4j5,
                "cField1": Fields.j4j5_sdk_1,
                "cField2": Fields.j4j5_sdk_2,
                "maxPaymentNum": "6",
                "paymentNum": "1"
            }
            ...
            self.current_step = "UI Payment (SDK Demo)"
...
if __name__ == "__main__":
    ...
    bot = SdkWalletJ4j5Bot(target_biz)
    success = bot.start()
